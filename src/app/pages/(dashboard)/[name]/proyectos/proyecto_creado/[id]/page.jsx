        ...
        <div className="flex flex-col lg:flex lg:flex-row">
            ...
            <div className="lg:w-[320px] mx-5 lg:mx-10 mt-10 lg:mt-0 mb-10">
                ...
                <div className="cuadro w-full h-[420px]  rounded-lg p-2 flex flex-col justify-between py-4 px-4">
                    ...
                    <Link href={`./${params.id}/tareas`} className="rounded-full text-center amarilloBack p-2 text-black font-bold">Editar tareas</Link>
                </div>
                <div className="cuadro mt-6 h-64 rounded-lg p-2 flex flex-col justify-between py-4 px-4">
                    ...
                    <Link href={`./${params.id}/tareas`} className="rounded-full text-center amarilloBack p-2 text-black font-bold">Editar integrantes</Link>
                </div>
            </div>
        </div>
