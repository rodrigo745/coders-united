...
export default function Columna(props){
    ...
    return(
        <div ref={setNodeRef} className="cuadro mx-7 lg:mx-0 lg:w-[20vw] rounded-lg lg:h-[500px] p-4 flex flex-col items-center">
            ...
            <div className='w-full text-center flex space-x-2 px-2'>
                <input type="text" placeholder={`Agregar tarea ${
                    props.tablero == "progreso" ? "en progreso" : props.tablero}`} 
                    className='p-2 text-sm bg-slate-600 rounded-full px-4 w-full'
                />
